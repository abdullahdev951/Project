    ...
    <DashboardLayout>
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-4">
          {/* Profile Section */}
          <div className="bg-[#141a22] rounded-2xl border border-[#232b36] p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between py-3 border-b border-[#232b36]">
                <div>
          ...
          <div className="bg-[#141a22] rounded-2xl border border-[#232b36] p-6">
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={item.label} className="flex items-center justify-between py-3 border-b border-[#232b36] last:border-0">
                  <div>
          ...
          <div className="bg-[#141a22] rounded-2xl border border-[#232b36] p-6">
            ...
            <div className="flex items-center justify-between py-3">
              ...
              <button className="px-4 py-2 rounded-xl border border-[#232b36] hover:bg-[#232b36] text-sm font-medium text-slate-300 transition-all">
                Enable
              </button>
            </div>
          </div>
          ...
          {/* Danger Zone */}
          <div className="bg-[#141a22] rounded-2xl border border-red-800/30 p-6">
            <div className="flex items-center gap-3 mb-5">
