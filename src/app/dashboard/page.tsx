  ...
  return (
    <DashboardLayout>
      <div className="max-w-6xl mx-auto">
        ...
        {/* Key Metrics Row */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 stagger">
          {/* Revenue */}
          ...
          <div className={`bg-[#141a22] rounded-2xl border ${isProfit ? "border-primary/30" : "border-red-800/30"} p-4 sm:p-5 card-hover`}>
            <div className="flex items-center justify-between mb-3">
              ...
              <span className={`text-xs font-bold px-2 py-0.5 rounded-full ${isProfit ? "bg-primary/15 text-primary-light" : "bg-red-900/30 text-red-400"}`}>
                {isProfit ? "PROFIT" : "LOSS"}
              </span>
            </div>
            <p className="text-[10px] sm:text-xs text-slate-400 uppercase tracking-wider mb-1">Monthly {isProfit ? "Profit" : "Loss"}</p>
            <p className={`text-xl sm:text-2xl font-extrabold ${isProfit ? "text-primary-light" : "text-red-400"}`}>
          ...
          <div className="bg-[#141a22] rounded-2xl border border-[#1b222c] p-4 sm:p-5 card-hover">
            <div className="flex items-center justify-between mb-3">
              <div className="w-10 h-10 rounded-xl bg-sky-500/10 flex items-center justify-center">
                <HiOutlineUserGroup className="text-sky-400 text-lg" />
              </div>
            </div>
          ...
          <div className="lg:col-span-2 bg-[#141a22] rounded-2xl border border-[#1b222c] p-4 sm:p-6">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="h-4 bg-[#0b0e13] rounded-full overflow-hidden">
                  <div className="h-full bg-gradient-to-r from-primary to-primary-light rounded-full transition-all duration-1000" style={{ width: "100%" }} />
                </div>
              </div>
          ...
          <div className="bg-[#141a22] rounded-2xl border border-[#1b222c] p-4 sm:p-6 flex flex-col">
            ...
            <div className="space-y-3 pt-4 border-t border-[#232b36]">
              <div className="flex items-center justify-between">
                ...
                <span className={`text-xs font-bold ${isProfit ? "text-primary-light" : "text-red-400"}`}>{profitMargin.toFixed(1)}%</span>
              </div>
              <div className="flex items-center justify-between">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
          ...
          <Link href="/reports" className="group">
            <div className="bg-[#141a22] rounded-2xl border border-[#1b222c] p-5 hover:border-primary transition-all h-full">
              <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center mb-3">
                <HiOutlineDocumentChartBar className="text-primary-light text-lg" />
              </div>
          ...
          <div className="bg-[#141a22] rounded-2xl border border-[#1b222c] p-5">
            <div className="w-10 h-10 rounded-xl bg-amber-500/10 flex items-center justify-center mb-3">
              <HiOutlineBuildingOffice2 className="text-amber-400 text-lg" />
            </div>
